...
function consulta03_form_inicio(){    


        ajax.url = html.url.absolute()+'/publico/consulta03/htmf/form.html'; 
        ajax.metodo = "GET";            
        document.getElementById( "formcent" ).innerHTML =  ajax.public.html();       
   

        // cargar combo
        consulta03_cargar_combo();
    
    
        //formdet       
        ajax.url = html.url.absolute()+'/publico/consulta03/htmf/resultado.html'; 
        ajax.metodo = "GET";            
        document.getElementById( "formdet" ).innerHTML =  ajax.public.html();  
        
        consulta03_interaccion();
...
function consulta03_cargar_combo (){        
...
function consulta03_interaccion (){        
...
function consulta03_datos (){        
        ...
        ajax.url = html.url.absolute()+'/api/departamentos/consulta/consulta03/'+
            ...
            tabla.linea =  "dpto";
            tabla.campos = ['dpto', 'descripcion',  'total_rendicion'];;                    
