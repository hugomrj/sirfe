...
@WebServlet(name = "ConsultaXLS_003", 
        urlPatterns = {"/consulta/publico/003.xls"})

public class ConsultaXLS_003 extends HttpServlet {
            ...
            throws IOException, SQLException, Exception
 {
        //response.setContentType("text/html;charset=UTF-8");
            ...
            {  
                ...
                if (!( fechadesde.trim().equals("0") || fechahasta.trim().equals("0")) )
                {
                    ...
                    cabecera.add("resolucion");                
                    cabecera.add("cant. transferencias");                
                    cabecera.add("total transferido");                
                    cabecera.add("total rendido");                
                    cabecera.add("saldo");                
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ConsultaXLS_003.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
