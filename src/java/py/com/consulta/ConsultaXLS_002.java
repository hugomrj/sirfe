...
@WebServlet(name = "ConsultaXLS_002", 
        urlPatterns = {"/consulta/publico/002.xls"})

public class ConsultaXLS_002 extends HttpServlet {
            ...
            throws IOException, SQLException, Exception
 {
        //response.setContentType("text/html;charset=UTF-8");
            ...
            {  
                ...
                Integer estado_resolucion = 0;                    
                estado_resolucion = Integer.parseInt( request.getParameter("estado_resolucion").toString()) ;  
                ...
                Integer objeto_desde = 0;                    
                objeto_desde = Integer.parseInt( request.getParameter("objeto_desde").toString()) ;  
                                    
                Integer objeto_hasta = 0;                    
                objeto_hasta = Integer.parseInt( request.getParameter("objeto_hasta").toString()) ;  
                ...
                if (!( fechadesde.trim().equals("0") || fechahasta.trim().equals("0")) )
                {
                    ...
                    cabecera.add("objeto");
                    cabecera.add("objeto descripcion");
                    cabecera.add("dpto");
                    cabecera.add("dpto descripcion");
                    cabecera.add("codigo");
                    cabecera.add("consejo");
                    ...
                    */
                    ...
                    ResultSet resulset = rs.consulta002( estado_resolucion,
                            fechadesde, fechahasta, 
                            dpto_desde, dpto_hasta, 
                            consejo_desde, consejo_hasta, 
                            objeto_desde, objeto_hasta,                    
                            tipo_transferencia);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ConsultaXLS_002.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
