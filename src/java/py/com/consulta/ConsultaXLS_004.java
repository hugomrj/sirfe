...
@WebServlet(name = "ConsultaXLS_004", 
        urlPatterns = {"/consulta/publico/004.xls"})

public class ConsultaXLS_004 extends HttpServlet {
            ...
            throws IOException, SQLException, Exception
 {
            ...
            {  
                ...
                if (!( fechadesde.trim().equals("0") || fechahasta.trim().equals("0")) )
                {
                    ...
                    */
                    ...
                    ResultSet resulset = rs.consulta004( estado_resolucion,
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ConsultaXLS_004.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
