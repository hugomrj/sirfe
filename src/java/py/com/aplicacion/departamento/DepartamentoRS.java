...
public class DepartamentoRS  {
    ...
    public DepartamentoRS ( ) throws IOException, SQLException  {
        conexion.conectar();  
...
//            String sql = SentenciaSQL.select(new Departamento());            
            String sql =    "   SELECT dpto, descripcion, verificador\n" +
    ...
    public ResultSet  search ( Integer page, String busqueda ) throws Exception {
            ...
            statement = conexion.getConexion().createStatement();                  
            String sql = new DepartamentoSQL().search(busqueda);
    ...
    public ResultSet  all (  ) throws Exception {
            ...
            String sql = "  SELECT dpto, descripcion\n" +
                            "  FROM aplicacion.departamentos\n" +
                            "  order by dpto  " ;
    ...
    public ResultSet  consulta03 (Integer resolucion_estado,
            ...
            String sql = new DepartamentoSQL().consulta03 ( 
